            ...
            <table class="table table-striped table-condensed receipt">
                ...
                <?php
					...
					foreach ($rows as $row) {
						...
						echo '<td class="text-center ft-14">' . $this->erp->formatQuantity($row->quantity);
						
						echo '<td class="text-center ft-14">' . $this->erp->formatMoney($row->real_unit_price) . '</td>';
						$colspan = 5;
						if ($inv->order_discount != 0 || $row->item_discount != 0) {
							echo '<td class="text-center">';
							echo '<span class="ft-14">' ;
						...
						echo '<td class="text-right ft-14">' . ($this->erp->formatMoney($row->subtotal) == 0 ? $free:$this->erp->formatMoney($row->subtotal)) . '</td>';
						$r++;
                ...
                <tr>
                    ...
                    <th class="text-right ft-14"><?= $this->erp->formatMoney($inv->total + $inv->product_tax); ?></th>
                </tr>
				
                <?php
                if ($inv->order_tax != 0) {
                    echo '<tr><th colspan="' . $colspan . '" class="text-right">' . lang("tax") . '</th>';
					echo '<th class="text-right ft-14">' . $this->erp->formatMoney($inv->order_tax) . '</th></tr>';
                }
                if ($inv->order_discount != 0) {
                    echo '<tr><th colspan="' . $colspan . '" class="text-right ft-14" style="border-top:2px dotted #ddd;padding-right: 12px;">' . lang("order_discount") . '(' . (strpos($inv->order_discount_id, '%')?$inv->order_discount_id:$inv->order_discount_id . '%') . ')</th><th style="border-top:2px dotted #ddd #ddd" class="text-right">'.$this->erp->formatMoney($inv->order_discount) . '</th></tr>';
                }
                ...
                ?>
                    <tr>
                        ...
                        <th style="border-top:2px dotted #000" class="text-right ft-14"><?= $rounding; ?></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th style="border-top:2px dotted #000" class="text-right ft-14"><?= $this->erp->formatMoney($inv->grand_total + $rounding); ?></th>
                    </tr>
				...
				<?php if ($inv->order_discount != 0 || $inv->order_tax != 0) { ?>
                    <tr>
                        <th style="border-top:2px dotted #000;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("grand_total"); ?></th>
                        <th style="border-top:2px dotted #000" class="text-right ft-14"><?= $this->erp->formatMoney($inv->grand_total); ?></th>
                    </tr>
                <?php }
                        if ($inv->shipping != 0) { ?>
                    <tr>
                        <th style="border-top:2px dotted #000;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("shipping"); ?></th>
                        <th style="border-top:2px dotted #000" class="text-right ft-14"><?= $this->erp->formatMoney($inv->shipping); ?></th>
                    </tr>
                <?php }
				}
				$pos_paid = 0;
				...
				if($pos_paid >= $inv->grand_total){
					...
					<tr>
                        ...
                        <th style="border:2px solid #000;border-left:none;" class="text-right ft-14"><?= $this->erp->formatMoney($pos_paid); ?></th>
                    </tr>
                    <tr>
                        ...
                        <th style="border:2px solid #000;border-left:none;" class="text-right ft-14"><?= $inv->other_cur_paid  . '៛' ; ?></th>
                    </tr>
					<!--<tr>
					...
					<tr>
                        ...
                        <th style="border-top:2px dotted #000" class="text-right ft-14">
						<?php
                    ...
                    <tr>
						...
						<th style="border-top:2px dotted #000" class="text-right ft-14"><?= number_format(round((($pos_paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate->rate), -3) . '៛' ; ?></th>
                    </tr>
				<!--	<tr>
				...
				<!--	<tr>
                    ...
                    <tr>
                        <th style="border-top:2px dotted #000;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("due_amount_kh"); ?></th>
                        <th style="border-top:2px dotted #000" class="text-right ft-14"><?= number_format((($pos_paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate->rate) . ' ៛' ; ?></th>
                    </tr>
				<!--	<tr>
                        <th style="border-top:2px dotted #ddd;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right">Due Amount(BAHT)</th>
                        <th style="border-top:2px dotted #ddd" class="text-right"><?= $this->erp->formatMoney((($pos_paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate_th->rate ); ?></th>
