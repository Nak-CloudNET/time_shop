                            ...
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1" value="<?= $inv->grand_total - $inv->paid ?>" class="pa form-control kb-pad amount" amount="<?= $inv->grand_total - $inv->paid ?>" required="required"/>
                                        <input name="amounts" type="hidden" value="<?= $inv->grand_total - $inv->paid ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
