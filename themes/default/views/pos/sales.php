...
<script>
    $(document).ready(function () {
        var oTable = $('#POSData').dataTable({
            ...
            {column_number: 2, filter_default_label: "[<?=lang('last_payments_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('customer', (isset($_POST['customer']) ? '' : ""), 'class="form-control" id="customer" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("customer") . '"'); ?>
                            </div>
                        </div>
