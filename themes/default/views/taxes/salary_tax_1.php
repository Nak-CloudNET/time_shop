				...
				<div>
					...
					<table class="table table-date table-bordered put-border">
						...
						<tr class="ta-center padding-five">
							...
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_05_paid" id="sal_05_paid" class="form-control textbox text-right sal_05_paid" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p>
							</td>
				...
				<div>
					...
					<table class="table table-date table-bordered put-border">
						...
						<tr class="padding-five ta-right">
							...
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_06_paid" id="sal_06_paid" class="form-control textbox text-right sal_06_paid" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p>
							</td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:16%;background-color:#7f8c8d;color:white;"></td>
