...
<style>.table-body{font-size:11px;}.dak-border{border:1px solid black;}.black-box{background-color:#7f8c8d;width:34px;height:34px;text-align:center;}.float-left{float:left;}.put-border tr td{border:1px solid black !important;font-size: 9px;}.put-border th{border:1px solid black !important;font-size: 9px;}.title-style{font-size:12px !important; line-height:14px;}.text-style{font-size:9px !important; line-height:14px;} .input-date td{width:30px;height:10px;} .table-date td{border:0 !important;} .padding-less{padding:3px !important;}</style>
		...
		<div class="row">
			...
			<table class="table table-date table-bordered " style="width:100%;">
				...
				<tr>
						...
						<input type="text" class="form-control st_dd" name="st_dd" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
						...
						<td  class="padding-less">
						<input type="text" class="form-control st_mm" name="st_mm"style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
						...
						<td  class="padding-less">
						<input type="text" class="form-control st_yy" name="st_yy" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
						...
						<td  class="padding-less">
						<input type="text" class="form-control en_dd" name="en_dd" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
						...
						<td  class="padding-less">
						<input type="text" class="form-control en_mm" name="en_mm" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
						...
						<input type="text" class="form-control en_yy" name="en_yy" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
...
">	
			...
			<div class="col-md-12 col-xs-12  col-lg-12" style="margin-top:10px;">
					...
					<div class="table-body">
						<table width="">
							<tr width="214px">
								...
								<td width="214px" class="dak-border"><input type="text" class="form-control text-box pusa_act04" name="pusa_act04" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->pusa_act04? $front->pusa_act04 : ''?>"></td>
							</tr>
						...
						<table width="100%">
							<tr>
								...
								<td width="214px" class="dak-border"><input type="text" class="form-control text-box tax_credit_premonth05" name="tax_credit_premonth05" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->tax_credit_premonth05? $front->tax_credit_premonth05 : ''?>"></td>
							</tr>
					...
					<table width="100%">
						<tr>
							...
							<td width="214px" class="dak-border"><input type="text" class="form-control text-box ncredit_purch06" name="ncredit_purch06" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;float:left;
							height: 35px;" value="<?=$front->ncredit_purch06? $front->ncredit_purch06 : ''?>"></td>
						...
						<tr>
							...
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box strate_purch07" name="strate_purch07" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_purch07? $front->strate_purch07 : ''?>"></td>
							<td class="black-box dak-border">08</td>
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box strate_purch08" name="strate_purch08" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;float:left;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_purch08? $front->strate_purch08 : ''?>">	</td>
						</tr>
						<tr>
							<td>ការលក់តាមអត្រាធម្មតា 10% Standard rated sales  </td>
							<td class="black-box dak-border">09</td>
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box strate_imports09" name="strate_imports09" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_imports09? $front->strate_imports09 : ''?>"></td>
							<td class="black-box dak-border">10</td>
							<td width="214px"  class="dak-border"><input type="text" class="form-control strate_imports10 text-box" name="strate_imports10" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_imports10? $front->strate_imports10 : ''?>"></td>
						</tr>
						<tr>
							...
							<td width="214px" class="dak-border"><input type="text" class="form-control text-box total_intax11" name="total_intax11" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: ;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->total_intax11? $front->total_intax11 : ''?>"></td>
						</tr>
					...
					<table width="100%">
						<tr>
							...
							<td width="214px" class="dak-border"><input type="text" class="form-control text-box ntaxa_sales12" name="ntaxa_sales12" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;float:left;
							padding-right: 2px;
							height: 35px;" value="<?=$front->ntaxa_sales12? $front->ntaxa_sales12 : ''?>"></td>
							<td width="214px"  class="dak-border" colspan="2" style="background-color: #7f8c8d;"></td>
						</tr>
						...
						<tr>
							...
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box exports13" name="exports13" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->exports13? $front->exports13 : ''?>"></td>
						...
						<tr>
							...
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box strate_sales14" name="strate_sales14" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_sales14? $front->strate_sales14 : ''?>"></td>
							<td class="black-box dak-border">15</td>
							<td width="214px"  class="dak-border"><input type="text" class="form-control text-box strate_sales15" name="strate_sales15" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;float:left;
							padding-right: 2px;
							height: 35px;" value="<?=$front->strate_sales15? $front->strate_sales15 : ''?>"></td>
						</tr>
						<tr>
							<td colspan="3" style="text-align:right;">សរុបទឹកប្រាក់អាករលើធាតុចូល Total amount of input tax (05+08+10)</td>
						
							<td class="black-box dak-border">16</td>
							<td width="214px" class="dak-border"><input type="text" class="form-control text-box pay_difference16" name="pay_difference16" style="
							width: 220px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->pay_difference16? $front->pay_difference16 : ''?>"></td>
						</tr>
					...
					<table width="100%">
						<tr>
							...
							<td width="184px" class="dak-border"><input type="text" class="form-control text-box refund17" name="refund17" style="
							width: 190px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;float:left;
							padding-right: 2px;
							height: 35px;" value="<?=$front->refund17? $front->refund17 : ''?>"></td>
							...
							<td width="184px" class=" dak-border"><input type="text" class="credit_forward18 text-box" name="credit_forward18" style="
							width: 190px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							height: 35px;" value="<?=$front->credit_forward18? $front->credit_forward18 : ''?>"></td>
						</tr>
					</table>
				</div>
	...
	<?php
        ...
        <td><input type="text" class="form-control qty_1" name="qty_1[]"></td>
        ...
        <td><input type="text" class="form-control VAT_1" name="VAT_1[]"></td>
    </tr>';
    ?>
    <tr>
        <td></td>
...
Export Value</td>
	...
	<?php
        ...
        <td><input type="text" class="form-control qty_2" name="qty_2[]"></td>
		...
		<td><input type="text" class="form-control exv_2" name="exv_2[]"></td>
...
Value exclusive of VAT</td>
	...
	<?php
        ...
        <td><input type="text"  class="form-control qty_3" name="qty_3[]"></td>
        <td><input type="text" class="form-control VAT_3" name="VAT_3[]"></td>
        <td><input type="text" class="form-control DESC_3" name="DESC_3[]"></td>
        <td><input type="text" class="form-control INV_3" name="INV_3[]"></td>
		<td><input type="text" class="form-control VAT2_3" name="VAT2_3[]"></td>
    </tr>';
    ?>
    <tr>
        <td></td>
