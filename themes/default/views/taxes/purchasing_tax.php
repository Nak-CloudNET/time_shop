    ...
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, {"mRender": row_status_confirm}],
            ...
            {column_number: 8, filter_default_label: "[<?=lang('tax_ref');?>]", filter_type: "text", data: []},
        ], "footer");
                ...
                <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("amount_tax"); ?></th>
                            <th><?php echo $this->lang->line("total_amount"); ?></th>
                            <th><?php echo $this->lang->line("tax_ref"); ?></th>
