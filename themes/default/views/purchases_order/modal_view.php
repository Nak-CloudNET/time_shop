            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        <th><?= lang("quantity"); ?></th>
                        <?php
                            if ($inv->status == 'partial' || $inv->status == 'completed') {
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
							<td style="text-align:center; width:100px;"><?= $this->erp->formatMoneyPurchase($row->unit_cost/1.1); ?></td>
                            <?php
                            if ($Settings->tax1) {
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="<?= site_url('purchases_order/view/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('view') ?>">
