...
<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('purchases_order/getPurchaseOrder' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": fld}, {"bSortable": false}],
            'fnRowCallback': function (nRow, aData, iDisplayIndex){
                ...
                }else if(aData[5] == 'completed'){
					action.find('.add_purchase').remove();
					action.find('.edit').remove();
                    nRow.className = "purchase_order_link";
				}else{
					nRow.className = "purchase_order_link";
            ...
            {column_number: 2, filter_default_label: "[<?=lang('pur_no');?>]", filter_type: "text", data: []},
...
<?php if ($Owner || !$Admin) {
	    echo form_open('purchases_order/purchases_order_actions', 'id="action-form"');
	}
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=site_url('purchases_order/add')?>">
                ...
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=site_url('purchases_order')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            	foreach ($warehouses as $warehouse) {
                            	        echo '<li ' . ($warehouse_id && $warehouse_id == $warehouse->id ? 'class="active"' : '') . '><a href="' . site_url('purchases_order/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            	    }
                                ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("purchases_order"); ?>
                        <div class="row">
                        <div class="col-sm-4">
