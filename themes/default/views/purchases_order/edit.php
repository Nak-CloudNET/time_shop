<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: '<?= site_url('purchases_order/suggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 200,
	...
	var remove='<button type="button" data="" class="removefile btn btn-danger">&times;</button>';
		$(document).on('click', '.edit',function(){
			...
			var input = '';
			for(i=0;i < qty; i++){
				input += '<div style="display:flex;padding:5px 0px 5px 0px" class="remove"><input type="text" class="form-control serial_no">'+remove+'</div>';
			}
			$('#serial').html(input);
		});
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchases_order/edit/" . $inv->id, $attrib)
                ?>
                ...
                <div class="row">
                    ...
                    <!--    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('ordered' => lang('ordered'), 'received' => lang('received'), 'partial' => lang('partially_received'), 'pending' => lang('pending'));
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php echo form_input('expected_date', (isset($_POST['expected_date']) ? $_POST['expected_date'] : $this->erp->hrld($purchase->expected_date)), 'class="form-control input-tip datetime" id="expected_date" required="required"'); ?>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("document", "document") ?>
                                <input id="document1" type="file" data-browse-label="<?= lang('browse'); ?>" name="document1" data-show-upload="false"
                                       data-show-preview="false" class="form-control file">
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("document", "document") ?>
                                <input id="document2" type="file" data-browse-label="<?= lang('browse'); ?>" name="document2" data-show-upload="false"
                                       data-show-preview="false" class="form-control file">
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <input type="hidden" name="quote_id" value="<?= $purchase->quote_id; ?>" id="quote_id"/>
                        ...
                        <div class="col-md-12">
                            <div
                                class="from-group"><?php echo form_submit('edit_pruchase', $this->lang->line("submit"), 'id="edit_pruchase" class="btn btn-primary btn_purchase" style="padding: 6px 15px; margin:15px 0;"'); ?>
