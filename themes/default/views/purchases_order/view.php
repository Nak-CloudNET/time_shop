            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php } ?>
                        <li>
                            <a href="<?= site_url('purchases_order/edit/' . $inv->id) ?>">
                                <i class="fa fa-edit"></i> <?= lang('edit_purchase') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('purchases_order/pdf/' . $inv->id) ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        <tr>
                            ...
                            ?>
                            <th style="padding-right:20px;"><?= lang("net_unit_cost"); ?></th>
                            <?php
                            if ($Settings->tax1) {
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="text-align:center; width:120px; padding-right:10px;"><?= $this->erp->formatMoney($row->unit_cost / 1.1); ?></td>
                                <?php
                                if ($Settings->tax1) {
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= site_url('purchases_order/pdf/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('download_pdf') ?>">
                            <i class="fa fa-download"></i> <span class="hidden-sm hidden-xs"><?= lang('pdf') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= site_url('purchases_order/edit/' . $inv->id) ?>" class="tip btn btn-warning tip" title="<?= lang('edit') ?>">
