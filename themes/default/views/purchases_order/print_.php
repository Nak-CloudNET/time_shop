                ...
                <table class="table table-striped table-condensed" style="width: 100%;">
                    ...
                    foreach ($rows as $row):
							...
							if ($row->item_discount != 0) {
								echo '<del>' . $this->erp->formatMoneyPurchase($row->net_unit_price + ($row->item_discount / $row->quantity) + ($row->item_tax / $row->quantity)) . '</del> ';
							}

							echo $this->erp->formatMoneyPurchase($row->net_unit_price + ($row->item_tax / $row->quantity)) . '</span><span class="pull-right" style="border-left:none">' . $this->erp->formatMoney($row->subtotal) . '</td></tr>';
                    ...
                    <tr>
                        <td style="font-weight:bold;"><?= lang("total_amount"); ?>
                            (<?= $default_currency->code; ?>)
							<span style="text-align:left; font-weight:bold;" class="pull-right"><?= $this->erp->formatMoneyPurchase($inv->grand_total); ?></span>
                        </td>
                    ...
                    <tr>
                        <td style="font-weight:bold;"><?= lang("paid"); ?>
                            (<?= $default_currency->code; ?>)
							<span style="text-align:right; font-weight:bold;" class="pull-right"><?= $this->erp->formatMoneyPurchase($pos_paid); ?></span>
                        </td>
                    ...
                    <tr>
                        <td style="font-weight:bold;"><?= lang("balance"); ?>
                            (<?= $default_currency->code; ?>)
							<span style="text-align:right; font-weight:bold;" class="pull-right"><?= $this->erp->formatMoneyPurchase($pos_paid - $inv->grand_total); ?></span>
                        </td>
