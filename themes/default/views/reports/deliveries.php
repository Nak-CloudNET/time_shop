...
<script>
    $(document).ready(function () {
        var oTable = $('#DOData').dataTable({
            ...
            {column_number: 5, filter_default_label: "[<?=lang('total_sale');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('paid_sale');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('due_balance');?>]", filter_type: "text", data: []},
