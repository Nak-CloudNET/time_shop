...
$(document).ready(function () {
	...
	$('#excel').on('click', function (e) {
		...
		if ($('.checkbox:checked').length <= 0) {
			window.location.href = "<?= site_url('reports/productMonthlyInOutReport/0/xls/' . $product1 . '/' . $year2 . '/' . $category1 . '/' . $warehouse1 . '/' . $in_out2.'/'.$wid1) ?>";
			return false;
		}
	});
	$('#pdf').on('click', function (e) {
		e.preventDefault();
		if ($('.checkbox:checked').length <= 0) {
			window.location.href = "<?= site_url('reports/productMonthlyInOutReport/pdf/0/' . $product1 . '/' . $year2 . '/' . $category1 . '/' . $warehouse1 . '/' . $in_out2.'/'.$wid1) ?>";
			return false;
		}
	});
});
