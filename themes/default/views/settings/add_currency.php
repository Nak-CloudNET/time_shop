    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
				...
				echo form_dropdown('code', $code, '', 'class="form-control" id="code" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("country") . '"');
				?>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_input('country', '', 'class="form-control" id="country" required="required"'); ?> </div>
            </div>
