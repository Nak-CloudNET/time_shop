        ...
        <div class="modal-body">
			...
			<div class="form-group">
                ...
                <div class="controls"> <?php
                    ...
                    echo form_dropdown('brand', $ct, (isset($_POST['brand']) ? $_POST['brand'] : $parent_id), 'class="form-control select" id="brand" placeholder="'.$this->lang->line("select") . " " . $this->lang->line("main_brand").'"');
                    ?> </div>
            </div>
			<!--
            <div class="form-group">
