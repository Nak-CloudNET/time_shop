                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
						...
						<div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="purchase_prefix"><?= lang("purchase_order_prefix"); ?></label>

                                <?php echo form_input('purchase_order_prefix', $Settings->purchases_order_prefix, 'class="form-control tip" id="purchase_order_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
