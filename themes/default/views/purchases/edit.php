                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("document", "document") ?>
                                <input id="document1" type="file" data-browse-label="<?= lang('browse'); ?>" name="document1" data-show-upload="false" data-show-preview="false" class="form-control file">
                            </div>
                        </div>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("document", "document") ?>
                                <input id="document2" type="file" data-browse-label="<?= lang('browse'); ?>" name="document2" data-show-upload="false" data-show-preview="false" class="form-control file">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="purchase_id" value="<?= $id; ?>" id="purchase_id"/>
						<input type="hidden" class="form-control" id="get_is_serial">
						<input name="get_serial_number[]" type="hidden" class="get_serial_number" id="get_serial_number" value="">
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="from-group"><?php echo form_submit('edit_pruchase', $this->lang->line("submit"), 'id="edit_pruchase" class="btn btn-primary btn_purchase" style="padding: 6px 15px; margin:15px 0;"'); ?>
