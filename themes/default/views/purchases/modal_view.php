                ...
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="width: 80px; text-align:center; vertical-align:middle;"><?= $this->erp->formatQuantity($row->quantity_balance); ?></td>
                            <td style="width: 80px; text-align:center; vertical-align:middle;">
								<?php
									$serial = explode(',',$row->serial_no);
									echo '<ul style="list-style: outside none none; text-align: center; padding: 0px;">';
							...
							<td style="text-align:right; width:100px;"><?= $this->erp->formatMoneyPurchase($row->unit_cost/1.1); ?></td>
                            <?php
                            if ($Settings->tax1) {
                                $tax=substr($row->tax_name,-3);
                                echo '<td style="width: 100px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>('.$tax.')</small>' : '') . ' ' . $this->erp->formatMoney($row->item_tax) . '</td>';
                            }
                            if ($Settings->product_discount) {
