                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/excel/import_purchase.xlsx"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span class="text-info">
							(<?= lang("product_code") . ', ' . lang("net_unit_cost") . ', ' . lang("quantity") . ', ' . lang("warehouse_code") . ', ' . lang("reference_no") . ', ' . lang("date"). ', ' . lang("shop_id"). ', ' . lang("purchase_status"). ', ' . lang("payment_term"). ', ' . lang("payment_status"). ', ' . lang("shipping"). ', ' . lang("order_discount"). ', ' . lang("order_tax"); ?>
                                )
							</span> 
							<?php echo $this->lang->line("csv3"); ?><br>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="userfile" required="required" data-show-upload="false" data-show-preview="false" class="form-control file">
                        </div>
                    </div>
