            ...
            <div class="row padding10">
                ...
                <div class="col-xs-5">
                    <div class="bold">
                        ...
                        <div class="clearfix"></div>
                        <?php $this->erp->qrcode('link', urlencode(site_url('sales/view/' . $inv->id)), 2, FALSE, $inv->id); ?>
                        <img src="<?= base_url() ?>assets/uploads/qrcode<?= $this->session->userdata('user_id') . $inv->id; ?>.png"
                             alt="<?= $inv->reference_no ?>" class="pull-right"/>
                        <?php $br = $this->erp->save_barcode($inv->reference_no, 'code39', 60, FALSE, $inv->id); ?>
                    ...
                    <?php $r = 1;
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="text-align:right; width:90px;"><?= $this->erp->formatMoney($row->net_unit_price); ?></td>
                                <?php
                                    if ($Settings->tax1) {
