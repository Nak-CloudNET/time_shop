<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($inv) { ?>
			...
			localStorage.setItem('sales_status', '<?= $inv->sale_status ?>');
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php $sst = array('ordered' => lang('ordered'), 'pending' => lang('pending'), 'completed' => lang('completed'));
						...
						<input type="hidden" value="<?= ($inv->payment_status?$inv->payment_status:0) ?>" name="payment_status"/> 
						
						<input name="amount-paid" type="hidden" value="<?php echo isset($payment->amount)?$this->erp->formatDecimal($payment->amount):0 ?>"/>
						
						<input type="hidden" value="<?= ($payment->reference_no?$payment->reference_no:0)?>" name="payment_reference_no"/>
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('edit_sale', lang("submit"), 'id="edit_sale" class="btn btn-primary edit_sale" style="padding: 6px 15px; margin:15px 0;"'); ?>
