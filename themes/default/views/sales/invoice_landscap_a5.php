...
<div class="col-sm-12 no-print">
	...
	<a href="<?=base_url()?>pos/view/<?=$sid?>" target="_blank"><button class="btn btn-primary no-print" ><i class="fa fa-print"></i>&nbsp;<?= lang("print_carbon"); ?></button></a>&nbsp;&nbsp;
	
	<a href="<?=base_url()?>sales/invoice_portrait/<?=$sid?>" target="_blank"><button class="btn btn-primary no-print" ><i class="fa fa-print"></i>&nbsp;<?= lang("print_portrait"); ?></button></a>&nbsp;&nbsp;
	
	<a href="<?= site_url('pos/sales'); ?>"><button class="btn btn-warning no-print" ><i class="fa fa-heart"></i>&nbsp;<?= lang("back_to_sale"); ?></button></a>&nbsp;&nbsp;
	
	<a href="<?= site_url('pos'); ?>"><button class="btn btn-warning no-print" ><i class="fa fa-heart"></i>&nbsp;<?= lang("back_to_pos"); ?></button></a>
