					...
					<table class="table table-bordered table-hover table-striped print-table order-table">
						...
						?>
							<tr>
								...
								?>
								<td style="text-align:right; width:120px;vertical-align:middle;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->subtotal):$free; ?></td>
							</tr>
							<?php
							$r++;
						...
						<?php if ($inv->grand_total != $inv->total) { ?>
							<tr>
								...
								?>
								<td style="text-align:right; padding-right:10px; vertical-align:middle;"><?= $this->erp->formatMoney($inv->total + $inv->product_tax - $inv->product_discount); ?></td>
							</tr>
						<?php } ?>
