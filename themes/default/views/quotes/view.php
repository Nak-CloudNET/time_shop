                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped print-table order-table">
						...
						if(isset($deposits)){
							...
							<tr>
								<td colspan="<?= $col; ?>"
									style="text-align:right; padding-right:10px; font-weight:bold;"><?= $deposit->note; ?>
									(<?= $default_currency->code; ?>)
								</td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= $this->erp->formatMoney($inv->grand_total - $total_deposit); ?></td>
                        </tr>
