<script type="text/javascript">
    ...
    $(document).ready(function () {
		<?php if($catalog_id) { ?>
			localStorage.setItem('quitems', JSON.stringify(<?= $catalog_items; ?>));
		<?php } ?>
			...
			$.ajax({
				...
				success: function (data) {
					if (data === false) {
						...
						var deposit_amount1 = $(".deposit_total_balance").text()-0;
						...
						$('#dp_details2').html('<small>Customer Name: ' + data.name + '<br>Amount: <span class="deposit_total_amount2">' + total_amount_2 + '</span> - Balance: <span class="deposit_total_balance2">' +formatDecimal(total_amount_2 - amount) + '</span></small>');
			...
			$.ajax({
				...
				success: function (data) {
					if (data === false) {
						...
						$('#dp_details3').html('<small>Customer Name: ' + data.name + '<br>Amount: <span class="deposit_total_amount3">' + total_amount_3 + '</span> - Balance: <span class="deposit_total_balance3">' +formatDecimal(total_amount_3 - amount) + '</span></small>');
	...
	$(document).on('keydown','#amount_1, #amount_2, #amount_3', function(event){
	...
	$(document).on('change', '.paid_by_by', function () {
		...
		if(p_val == 'deposit') {
			$('.dp').show();
			var cust = $('#qucustomer').val();
			if(!cust){
				alert('Please select any customer');
			}
			$('#customer1').val(cust).trigger('change');
		}else{
			$('.dp').hide();
			$('#dp_details').html('');
		}
            ...
            <div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="col-md-4 service-wrap">
							<div class="form-group">
								...
								<?php
									...
									echo form_dropdown('services', $se, '', 'id="add_services" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("services") . '" class="form-control input-tip select" style="width:100%;"');
								?>
							</div>
						</div>
						...
						<?php echo form_hidden('shipping', '', 'class="form-control input-tip" id="qushipping"'); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<?= lang("document", "document") ?>
								<input id="document1" type="file" name="document1" data-show-upload="false"
									   data-show-preview="false" class="form-control file">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<?= lang("document", "document") ?>
								<input id="document2" type="file" name="document2" data-show-upload="false"
									   data-show-preview="false" class="form-control file">
							</div>
						</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<?php if ($Owner || $Admin || $GP['customers-add']) { ?><div class="input-group"><?php } ?>
													<?php
													echo form_input('customer', '', 'id="qucustomer" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" class="form-control input-tip" style="width:100%;"');
													?>
						...
						<div class="col-md-12">
							<div class="panel panel-info">
								...
								<div class="panel-body" style="padding: 5px;">	
									<div class="col-md-12" style="padding-bottom:10px;">
										<div class="col-md-4">
											...
											<?php 
												...
												'', 'id="type_payment" class="form-control type_payment"') ?>
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="payment">
												<div class="form-group ngc">
													...
													<input name="amount-paid" type="text" id="amount" class="pa form-control kb-pad amount"/>
												</div>
									...
									<div class="col-md-12 full-payment">
										...
										<div class="form-group dp" style="display: none;">
											...
											<?php
												...
												echo form_dropdown('customer1', $customers1, '' , 'class="form-control" id="customer1" style="display:none;"');
											?>
										...
										<div class="pbt_1" style="display:none;">
											<div class="form-group"><?= lang("bt_no", "bt_no_1"); ?>
												<input name="bt_no" type="text" id="bt_no_1"
													   class="form-control bt_no_1"/>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<select name="deposit1" id="paid_by_11" class="form-control paid_by_by1">
														<option value="cash"><?= lang("cash"); ?></option>
														<option value="deposit"><?= lang("Store_Credit"); ?></option>
														<option value="CC"><?= lang("CC"); ?></option>
														<option value="Cheque"><?= lang("cheque"); ?></option>
											...
											<div class="col-sm-12">
												<div class="payment">
													<div class="form-group ngc_1_1">
														...
														<input name="amount-paid_1_1" type="text" id="amount_1_1"
											...
											<div class="pcc_1_1" style="display:none;">
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_no_1_1" type="text" id="pcc_no_1_1" class="form-control" placeholder="<?= lang('cc_no') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_holder_1_1" type="text" id="pcc_holder_1_1" class="form-control"placeholder="<?= lang('cc_holder') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<select name="pcc_type_1_1" id="pcc_type_1_1" class="form-control pcc_type_1_1" placeholder="<?= lang('card_type') ?>">
															<option value="Diners_Club"><?= lang("Diners Club"); ?></option>
															<option value="JCB"><?= lang("JCB"); ?></option>
															<option value="Union_Pay"><?= lang("Union Pay"); ?></option>
															<option value="Visa"><?= lang("Visa"); ?></option>
											...
											<div class="col-md-12 pcheque_1_1" style="display:none;">
												<div class="form-group"><?= lang("cheque_no", "cheque_no_1_1"); ?>
													<input name="cheque_no1" type="text" id="cheque_no_1_1"
											...
											<div class="col-md-12 pbt_1_1" style="display:none;">
												<div class="form-group"><?= lang("bt_no", "bt_no_1_1"); ?>
													<input name="bt_no1" type="text" id="bt_no_1_1"
										...
										<div class="col-md-4">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<select name="deposit2" id="paid_by_12" class="form-control paid_by_by2">
														<option value="cash"><?= lang("cash"); ?></option>
														<option value="deposit"><?= lang("Store_Credit"); ?></option>
														<option value="CC"><?= lang("CC"); ?></option>
														<option value="Cheque"><?= lang("cheque"); ?></option>
											...
											<div class="col-sm-12">
												<div class="payment">
													<div class="form-group ngc_1_2">
														...
														<input name="amount-paid_1_2" type="text" id="amount_1_2"
											...
											<div class="pcc_1_2" style="display:none;">
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_no_1_2" type="text" id="pcc_no_1_2"
															   class="form-control" placeholder="<?= lang('cc_no') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_holder_1_2" type="text" id="pcc_holder_1_2"
															   class="form-control"
															   placeholder="<?= lang('cc_holder') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<select name="pcc_type_1_2" id="pcc_type_1_2" class="form-control pcc_type_1_2" placeholder="<?= lang('card_type') ?>">
															<option value="Diners_Club"><?= lang("Diners Club"); ?></option>
															<option value="JCB"><?= lang("JCB"); ?></option>
															<option value="Union_Pay"><?= lang("Union Pay"); ?></option>
															<option value="Visa"><?= lang("Visa"); ?></option>
											...
											<div class="col-md-12 pcheque_1_2" style="display:none;">
												<div class="form-group"><?= lang("cheque_no", "cheque_no_1_2"); ?>
													<input name="cheque_no_1_2" type="text" id="cheque_no_1_2"
											...
											<div class="col-md-12 pbt_1_2" style="display:none;">
												<div class="form-group"><?= lang("bt_no", "bt_no_1_2"); ?>
													<input name="bt_no2" type="text" id="bt_no_1_2"
										...
										<div class="col-md-4">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<select name="deposit3" id="paid_by_13" class="form-control paid_by_by3">
														<option value="cash"><?= lang("cash"); ?></option>
														<option value="deposit"><?= lang("Store_Credit"); ?></option>
														<option value="CC"><?= lang("CC"); ?></option>
														<option value="Cheque"><?= lang("cheque"); ?></option>
											...
											<div class="col-sm-12">
												<div class="payment">
													<div class="form-group ngc_1_3">
														...
														<input name="amount-paid_1_3" type="text" id="amount_1_3"
											...
											<div class="pcc_1_3" style="display:none;">
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_no_1_3" type="text" id="pcc_no_1_3"
															   class="form-control" placeholder="<?= lang('cc_no') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input name="pcc_holder_1_3" type="text" id="pcc_holder_1_3"
															   class="form-control"
															   placeholder="<?= lang('cc_holder') ?>"/>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<select name="pcc_type_1_3" id="pcc_type_1_3" class="form-control pcc_type_1_3" placeholder="<?= lang('card_type') ?>">
															<option value="Diners_Club"><?= lang("Diners Club"); ?></option>
															<option value="JCB"><?= lang("JCB"); ?></option>
															<option value="Union_Pay"><?= lang("Union Pay"); ?></option>
															<option value="Visa"><?= lang("Visa"); ?></option>
											...
											<div class="col-md-12 pcheque_1_3" style="display:none;">
												<div class="form-group"><?= lang("cheque_no", "cheque_no_1_3"); ?>
											...
											<div class="col-md-12 pbt_1_3" style="display:none;">
												<div class="form-group"><?= lang("bt_no", "bt_no_1_1"); ?>
													<input name="bt_no3" type="text" id="bt_no_1_3"
									...
									<!----- Admin Fee ------>
									<!--
									<div class="col-md-12 admin-fee" style="display:none">
										<div class="col-md-4">
											<div class="form-group">
												<?= lang("Payment_Method", "paid_by_14"); ?>
												<select name="paid_by_by" id="paid_by_14" class="form-control paid_by_by">
													<option value="cash"><?= lang("cash"); ?></option>
													<option value="deposit"><?= lang("Store_Credit"); ?></option>
													<option value="CC"><?= lang("CC"); ?></option>
													<option value="Cheque"><?= lang("cheque"); ?></option>
										...
										<div class="col-sm-4">
											<div class="payment">
												<div class="form-group ngc">
													<?= lang("amount", "amount_1_4"); ?>
													<input name="amount-paid_1_4" type="text" id="amount" class="pa form-control kb-pad amount"/>
												</div>
												<div class="form-group gc" style="display: none;">
													<?= lang("gift_card_no", "gift_card_no"); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="width:25%;"><?= lang('net_unit_prices'); ?></th>
