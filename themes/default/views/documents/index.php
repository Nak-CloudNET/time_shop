<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            {column_number: 5, filter_default_label: "[<?=lang('product_line');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('catalog'); ?></h2>
            ...
            <ul class="btn-tasks"> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('documents/add'); ?>" data-toggle="modal" data-target="#myModal" id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_catelog"); ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
