    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="well well-small">
                <a href="<?php echo base_url(); ?>assets/excel/import_customer.xlsx" class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample File</a>
            ...
            <div class="form-group">
                ...
                <input type="file" data-browse-label="<?= lang('browse'); ?>" name="excel_file" data-bv-notempty="true" data-show-upload="false"  data-show-preview="false" class="form-control file">
            </div>
        </div>
