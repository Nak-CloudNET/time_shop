    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <th style="text-align:center; vertical-align:middle;"><?php echo $this->lang->line("serial_no"); ?></th>
            ...
            foreach ($rows as $row):
                ...
                <tr>
                    ...
                    <td style="width: 150px; text-align:left; padding-right:10px; vertical-align:middle;"><?php echo $row->serial_no; ?></td> 
                </tr>
                <?php $r++;
            endforeach;
            ?>
