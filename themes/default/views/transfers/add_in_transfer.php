    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("transfers/add_in_transfer", $attrib)
                ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="toTable"
                                        ...
                                        <thead>
                                        <tr>
											<th class="col-md-1"><?=lang('image')?></th>
                                            <th class="col-md-5"><?= lang("product_name") . " (" . $this->lang->line("product_code") . ")"; ?></th>
											<th class="col-md-3"><?= lang('serial_no');?></th>
                                            <?php
                                            ...
                                            <th class="col-md-4" style="display:none;"><?= lang("subtotal"); ?> (<span
                            ...
                            <div class="from-group"><?php echo form_submit('add_transfer', $this->lang->line("submit"), 'class="btn btn-primary" id="add_transfer" style="padding: 6px 15px; margin:15px 0;"'); ?>
