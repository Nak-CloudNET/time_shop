<script>
    $(document).ready(function () {
        var oTable = $('#TOData').dataTable({
            ...
            {column_number: 2, filter_default_label: "[<?=lang('transfer_no');?>]", filter_type: "text", data: []},
            {
                column_number: 3,
		...
		$(document).on('click', '#transfer-back', function(){
			bootbox.confirm('Are you sure to transfer it back?', function(){
				return true;
			});
			return false;
		});
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('transfers/add_in_transfer') ?>">
