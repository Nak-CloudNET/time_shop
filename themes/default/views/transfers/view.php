    ...
    <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tr>
                        ...
                        <th style="vertical-align:middle;width:200px"><?= lang("description"); ?></th>
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="text-align:center; width:80px; "><?= $this->erp->formatQuantity($row->quantity); ?></td>
                             <td style="text-align:center; width:150px; "><?=$row->serial_no; ?></td>
                        </tr>
                        <?php $r++;
                    endforeach; ?>
                    </tbody>
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
					<?php
						$attachment = $transfer->attachment.','.$transfer->attachment1.','.$transfer->attachment2;
						if($attachment){
