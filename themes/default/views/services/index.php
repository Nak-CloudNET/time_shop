<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('services/getServices') ?>',
			...
			{column_number: 2, filter_default_label: "[<?=lang('se');?>]", filter_type: "text", data: []},
			{column_number: 3, filter_default_label: "[<?=lang('services');?>]", filter_type: "text", data: []},
			...
			{column_number: 6, filter_default_label: "[<?=lang('ref');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('list_services'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:40px; width: 40px; text-align: center;"><?php echo $this->lang->line("date"); ?></th>
                            <th style="width:150px !important;"><?= lang("se"); ?></th>														<th><?= lang("customer_name"); ?></th>							
                            <th><?= lang("brand"); ?></th>
							<th><?= lang("type"); ?></th>
                            <th><?= lang("ref"); ?></th>
