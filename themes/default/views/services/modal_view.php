<style>
	.strike {
		background-image: -moz-linear-gradient(top , rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px);
		background-image: -webkit-linear-gradient(rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px);
		background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px);
	...
	@media print
   {
	   ...
	   .title > tr > th {
		...
		.strike {
			background-image: -moz-linear-gradient(top , rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px) !important;
			background-image: -webkit-linear-gradient(rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px) !important;
			background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0) 34px, #000000 34px, #000000 36px) !important;
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		<div class="modal-body">
            ...
            <button type="button" class="btn btn-xs btn-default no-print pull-right" style="margin-right:15px;" onclick="document.title='<?php echo $services->service_number;?>'; window.print();">
            ...
            <div class="row">
				<div class="col-sm-12" style="text-align:center;">
					...
					<div style="font-size:12px;">
						...
						<span id="serial_no" style="color: red;font-size: 18px;position: absolute;right: 80px;top: 100px;"><?= ':'.$services->service_number;?></span>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 col-lg-12">
					<div class="col-md-9 col-xs-9 col-lg-9" style="padding:0;">
						...
						<div style="float: left; width: 22%;border-bottom:1px solid #000;"><?= ($services->cname == "" ? '&nbsp;':$services->cname );?></div>
						<div style="float: left; width: 16%; text-align: center;">IC/Passport No</div>
						<div style="float: left; width: 29%;border-bottom:1px solid #000;"><?= ($services->ic_passport_no == "" ? '&nbsp;':$services->ic_passport_no );?></div>
						<div style="float: left; width: 20%; text-align: center;">Date of reception</div>
					</div>
					<div class="col-md-3 col-xs-3 col-lg-3" style="padding:0;border-bottom:1px solid #000;"><?= ($services->date_of_reception == "" ? '&nbsp;':$services->date_of_reception );?></div>
				</div>
				<div class="col-md-12 col-xs-12 col-lg-12">
					<div class="col-md-9 col-xs-9 col-lg-9" style="padding:0;">
						<div style="width:13%;float:left;">Contact<span style=" float: right; padding-right: 5px;text-align: right;">:</span></div>
						<div style="float: left; width: 24%;border-bottom:1px solid #000;"><?= ($services->hpline == "" ? '&nbsp;':$services->hpline )?></div>
						<div style="float: left; width: 5%; text-align: center;">(HP)</div>
						<div style="float: left; width: 24%;border-bottom:1px solid #000;"><?= ($services->hline == "" ? '&nbsp;':$services->hline );?></div>
				...
				<div class="col-md-12 col-xs-12 col-lg-12">
					<div class="col-md-11 col-xs-11 col-lg-11" style="padding:0;">
						<div style="width:13%;float:left;">Email<span style=" float: right; padding-right: 5px;text-align: right;">:</span></div>
						<div style="float: left; width: 45%;border-bottom:1px solid #000;padding-right:2%;"><?= ($services->email == "" ? '&nbsp;':$services->email );?></div>
						<div style="float:left;width:39%">
							<div style="float:left;padding-left:10px;">
								<span style="float:left;">&nbsp; Existing Customer</span> 
								<span style="float:left;padding-left:10px;">
									<?php
										if($services->type_customer == 1){
							...
							<div style="float:left;padding-left:10px;"><span style="float:left;">&nbsp; Walk in</span> 
								<span style="float:left;padding-left:10px;">
									<?php
										if($services->type_customer != 1){
											echo '<i class="fa fa-check-square-o" aria-hidden="true"></i>';
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 col-lg-12">
					...
					<div style="width:30%;float:left;border-bottom:1px solid #000;">
						<?= ($services->brand_name == "" ? '&nbsp;':$services->brand_name);?>
					</div>
				...
				<div class="col-md-12 col-xs-12 col-lg-12">
					...
					<div style="width:15%;float:left;border-bottom:1px solid #000;">
						<?= ($services->tmodal == "" ? '&nbsp;':$services->tmodal);?>
					</div>
					<div style="width:10%;float:left;text-align:center;">Description:</div>				
					<div style="width:18%;float:left;border-bottom:1px solid #000;">
						<?= ($services->detail2 == "" ? '&nbsp;':$services->detail2);?>
					</div>
					<div style="width:8%;float:left;text-align:center;">Serial No:</div>
					<div style="width:15%;float:left;border-bottom:1px solid #000;"><?= ($services->serial_no == "" ? '&nbsp;':$services->serial_no);?></div>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 col-lg-12" style="text-align:left;">
					<div style="padding:15px 0 15px 5px;border:1px solid #ccc;">
						<div style="width: 80%;">REMARKS</div>
						<div id="serial_no" style="color: red;font-size: 18px;width: 20%;float:right;position:absolute;right:-40px;top:13px;"><?= ':'.$services->service_number;?></div>
					</div>
				</div>
			</div>
			<br/>
			<div class="row">
				<div class="col-md-12 col-xs-12 col-lg-12">
					<div class="detail">
					<?php
					$text = str_replace('<p>', ' ', $services->detail1);
					$textG = str_replace('</p>', ' ',$text );
					?>
					<p class="strike">
						<span>
							<?php echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$textG; ?>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 col-lg-12">
					<ul style="padding-left:15px;list-style-type: square;">
						...
						<li>Client will be notified by staff of Timepieces Boutique on the repair charges via email and/or prefered mode of contact as per stipulated.</li>
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="table3">
							...
							<tr>
								...
								<td id="title3" style="background-color:black;color:white;text-align:center;border:none !important;">CLiENT'S ACKNOWLEDGEMENT</td>
							</tr>
							<tr style="border:1px solid #000;">
								<td style="border:1px solid #000;width:50%;">
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Staff Name</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->staff_name == "" ? '&nbsp;':$services->staff_name);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Signature</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->staff_signature == "" ? '&nbsp;':$services->staff_signature);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Date</div>
										<div style="width:70%; float:left; border-bottom:1px solid #000;">
											<?php
												if(strtotime($services->staff_date) != ''){
													echo $services->staff_date;
												} else {
													echo '&nbsp;';
												}
								...
								<td style="border:1px solid #000;width:50%;">
									<div class="" style="width:100%;float:left;">
										...
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->client_name == "" ? '&nbsp;':$services->client_name);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Signature</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->client_signature == "" ? '&nbsp;':$services->client_signature);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Date</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;">
											<?php
												if(strtotime($services->client_date) != ''){
													echo $services->client_date;
												} else {
													echo '&nbsp;';
												}
							...
							<tr style="border:1px solid #000;">
								<td style="border:1px solid #000;width:50%;">
									<div class="" style="width:100%;float:left;">
										...
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->staff_name1 == "" ? '&nbsp;':$services->staff_name1);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Signature</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->staff_signature1 == "" ? '&nbsp;':$services->staff_signature1);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Date</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;">
											<?php
												if(strtotime($services->staff_date1) != ''){
													echo $services->staff_date1;
												} else {
													echo '&nbsp;';
												}
								...
								<td style="border:1px solid #000;width:50%;">
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Name</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->client_name1 == "" ? '&nbsp;':$services->client_name1);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Signature</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;"><?= ($services->client_signature1 == "" ? '&nbsp;':$services->client_signature1);?></div>
									</div>
									<div class="" style="width:100%;float:left;">
										<div style="width:30%;float:left;">Date</div>
										<div style="width:70%;float:left;border-bottom:1px solid #000;">
											<?php
												if(strtotime($services->client_date1) != ''){
													echo $services->client_date1;
												} else {
													echo '&nbsp;';
												}
