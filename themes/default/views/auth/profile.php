<div class="row">
										...
										<td style="width:80%;">
											<div class="input-group" style="width:100%;">
												<?php
													...
													echo form_dropdown('cate[]', $cats, $p->sales_category, 'id="cate" class="form-control" multiple="multiple"');
												?>
											</div>
										</td>
									</tr>
    ...
    <script>
        $(document).ready(function () {
			...
			var string = '<?php echo $p->sales_category ?>';
			var array = string.split(',');
			$("#cate").val(array);
			var pur = '<?php echo $p->purchase_category ?>';
			var arrays = pur.split(',');
			$("#pcate").val(arrays);
        });
    </script>
    <?php if ($Owner && $id != $this->session->userdata('user_id')) { ?>
