        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
					...
					<div class="form-group">
						<?= lang('style', 'style'); ?>
						<?php $opts = array('' => lang('select').' '.lang('style'), 6 => lang('5_price_stemp'),40 => lang('40_per_sheet'), 30 => lang('30_per_sheet'), 24 => lang('24_per_sheet'), 20 => lang('20_per_sheet'), 18 => lang('18_per_sheet'), 14 => lang('14_per_sheet'), 12 => lang('12_per_sheet'), 10 => lang('10_per_sheet'), 50 => lang('continuous_feed')); ?>
                            ...
                            if (!empty($barcodes)) {
                                ...
                                if ($style == 12 || $style == 18 || $style == 24 || $style == 40) {
                                    echo '<div class="barcodea4">';
									     echo '<div style="width:100%;height:11.6in">';
                                } elseif ($style != 50) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
										...
										if($style == 6){
											echo '<div style="max-width:50%;float:left; ">';
											if($item['image']){
											...
											if($item['site']){
												echo '<span class="barcode_site" style="font-size:10px;float:left;">'.$item['site'].'</span>';
											}
											if($item['name']){
												echo '<span class="barcode_name bar_name">'.$item['name'].'</span>';
											}
											if($item['unit']) {
											...
											if($item['price']) {
												echo '<span class="barcode_price bar_price" style="font-size:20px; display:block;">'.lang('$').' ';
												if($item['currencies']) {
										   ...
										   echo '</span>';
											...
											if($item['site']) {
												echo '<span class="barcode_site" style="font-size:10px">'.$item['site'].'</span>';
											}
											if($item['name']) {
