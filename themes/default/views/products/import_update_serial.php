<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_update_serial'); ?></h4>
        </div>
        <?php
        $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("products/import_update_serial", $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/excel/import_update_serial_number.xlsx" class="btn btn-primary pull-right">
