					...
					?>
						<div class="col-md-5">
							...
							<div class="form-group all">
								...
								<?= form_input('name', (isset($_POST['name']) ? $_POST['name'] : ($product ? $product->name : '')), 'class="form-control" id="name"'); ?>
							</div>
							<div class="form-group all">
							...
							<div class="form-group all">
								...
								echo form_dropdown('category', $cat, (isset($_POST['category']) ? $_POST['category'] : ($product ? $product->category_id : '')), 'class="form-control select" id="categories" placeholder="' . lang("select") . " " . lang("category") . '" style="width:100%"')
								?>
							</div>
							<div class="form-group all">
							...
							<div id="promo" style="display:none;">
							 ...
							 <?php if ($Settings->tax1) { ?>
								...
								<div class="form-group all">
									...
									<?php
									$tm = array('1' => lang('inclusive'), '2' => lang('exclusive'));
							...
							<div class="standard">
								<div class="form-group">
									<input type="checkbox" class="checkbox" name="related_strap"
										   id="related_strapp" <?= $this->input->post('related_strap') || $product_options ? 'checked="checked"' : ''; ?>><label
										for="related_strap"
										class="padding05"><?= lang('related_strap'); ?></label>
								</div>
								<div class="well well-sm" id="strapp-con"
						...
						<div class="col-md-12">
							...
							<?php }?>
							<div class="form-group">
								<input name="cf" type="checkbox" class="checkbox" id="ex" value="" /><label for="extras" class="padding05"><?= lang('custom_fields') ?></label>
							</div>
							<div class="row" id="ex-con" style="display: none;">
