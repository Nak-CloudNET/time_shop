<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('import_products'); ?></h2>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="well well-small">
                            <a href="<?php echo base_url(); ?>assets/excel/import_products.xlsx"
                               class="btn btn-primary pull-right" download="import_products.xlsx"><i class="fa fa-download"></i> <?= lang("download_sample_file") ?></a>
