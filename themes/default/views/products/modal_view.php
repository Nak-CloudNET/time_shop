        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-7">
					...
					if ($product->is_serial && ($Owner || $Admin || $this->GP['products-serial'] )) { ?>
...
<div class="col-xs-12">
    ...
    <?= $product->product_details ? '<div class="panel panel-primary"><div class="panel-heading">' . lang('product_description') . '</div><div class="panel-body">' . $product->product_details . '</div></div>' : ''; ?>
...
<div class="buttons">
    <div class="btn-group btn-group-justified">
        ...
        <?php if($product->type == 'standard' && ($Owner || $Admin || $this->GP['products-adjustments'] ) ) { ?>
			<div class="btn-group">
