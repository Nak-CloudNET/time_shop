                        ...
                        <div class="col-md-12">
							...
							<div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $ptype["1"] = lang('taxable_purchase');
                                    $ptype["2"] = lang('non_taxable_purchase');
                                    $ptype["3"] = lang('import');                 
                                ...
                                <?php if ($Settings->tax1) { ?>
                                    <div class="col-md-4">
									   ...
									   <div class="form-group two_use" >
                                            ...
                                            echo form_dropdown('order_tax', $tr1,2, 'id="potax22" class="form-control input-tip select"  style="width:100%;"' );
                                            ?>
                                        </div>
