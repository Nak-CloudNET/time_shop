<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('import_price_cost'); ?></h2>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="well well-small">
                            <a href="<?php echo base_url(); ?>assets/excel/import_product_price_cost.xlsx"
							...
							<span class="text-info">
								(<?= lang("product_code") . ', ' . lang("product_price"); ?>
                                )
							</span> <?= lang("csv3"); ?>
