                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $product->un_name; ?></td>
                                        </tr>
                                        <?php if ($Owner || $Admin) {
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                        ...
                                        <?php if ($product->cf1 || $product->cf2 || $product->cf3 || $product->cf4 || $product->cf5 || $product->cf6) { ?>
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <?php
                                                   if ($cf1data) {
                                                        echo '<tr><td>' . lang("pcf1") . '</td><td>' . $cf1data->name . '</td></tr>';
                                                    }
                                                    if ($cf2data) {
                                                        echo '<tr><td>' . lang("pcf2") . '</td><td>' . $cf2data->name . '</td></tr>';
                                                    }
                                                    if ($cf3data) {
                                                        echo '<tr><td>' . lang("pcf3") . '</td><td>' . $cf3data->name . '</td></tr>';
                                                    }
                                                    if ($cf4data) {
                                                        echo '<tr><td>' . lang("pcf4") . '</td><td>' . $cf4data->name . '</td></tr>';
                                                    }
                                                    if ($cf5data) {
                                                        echo '<tr><td>' . lang("pcf5") . '</td><td>' . $cf5data->name . '</td></tr>';
                                                    }
                                                    if ($cf6data) {
                                                        echo '<tr><td>' . lang("pcf6") . '</td><td>' . $cf6data->name . '</td></tr>';
                                                    }
                                                    if ($cf7data) {
                                                        echo '<tr><td>' . lang("pcf7") . '</td><td>' . $cf7data->name . '</td></tr>';
                                                    }
                                                    if ($cf8data) {
                                                        echo '<tr><td>' . lang("pcf8") . '</td><td>' . $cf8data->name . '</td></tr>';
                                                    }
                                                    if ($cf9data) {
                                                        echo '<tr><td>' . lang("pcf9") . '</td><td>' . $cf9data->name . '</td></tr>';
                                                    }
                                    ...
                                    <div class="col-sm-7">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <?php foreach ($combo_items as $combo_item) {
                                                        echo '<tr><td>' . $combo_item->name . ' (' . $combo_item->code . ') </td><td>' . $this->erp->formatQuantity($combo_item->cqty) . '</td></tr>';
                                                    } ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <?php } ?>
                                        <?php if ($product->is_serial && ($Owner || $Admin || $this->GP['products-serial'] ) ) { ?>
                                            <h3 class="bold"><?= lang('serial_number') ?></h3>
                                            <div class="table-responsive">
                                                    ...
                                                    <tbody>
                                                        <!-- <?php 
                                                            ...
                                                            foreach ($serial_number as $serial) {
                                                               $ser[] = $serial->serial_number;
                                                            } 
                                                            $ser_no = join(",",$ser);
                                                            $s_n = explode(',', $ser_no);
                                                            foreach ($s_n as $serial_no) {
                                                                echo '<tr><td>' . $serial_no .'</td><td>' . $this->erp->formatQuantity($warehouse->quantity) . '</td></tr>';
                                                            }
                                                        ?> -->
                                                        <?php 
                                                            $ser = array();
                                                            ...
                                                            foreach ($serials as $serial) {
                                                                echo '<tr>';
                                                                echo '<td>'.$serial->serial_number.'</td>';
                                                                if($serial->serial_status == 1){
                                                                    echo '<td>1</td>';
                                                                }else{
                                                                    echo '<td>0</td>';
                                                                }
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var oTable = $('#SlRData').dataTable({
                    ...
                    'sAjaxSource': '<?= site_url('reports/getProductSaleReport/?v=1&product='.$product->id . '&product_type='.$product->type) ?>',
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var total_qty = 0, gtotal = 0, paid = 0, balance = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            total_qty += parseFloat(aaData[aiDisplay[i]][4]);
                            gtotal += parseFloat(aaData[aiDisplay[i]][5]);
                            paid += parseFloat(aaData[aiDisplay[i]][6]);
                            balance += parseFloat(aaData[aiDisplay[i]][7]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[4].innerHTML = formatQuantity2(parseFloat(total_qty));
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var oTable = $('#QuRData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getQuotesProduct/?v=1&product='.$product->id . '&product_type='.$product->type) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "aoColumns": [{"mRender": fld}, null, null, null, {"mRender": formatQuantity2}, {"mRender": currencyFormat}, {"mRender": row_status}],
					"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var total_qty = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            total_qty += parseFloat(aaData[aiDisplay[i]][4]);
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var oTable = $('#PoRData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getProductPurchasesReport/?v=1&product=' . $product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        ...
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[5].innerHTML = formatQuantity2(parseFloat(qty));
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var oTable = $('#TrRData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getTransfersProduct/?v=1&product='.$product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "aoColumns": [{"mRender": fld}, null, {"mRender": formatQuantity2}, null, null, {"mRender": currencyFormat}, {"mRender": row_status}],
					"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var qty = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            qty += parseFloat(aaData[aiDisplay[i]][2]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[2].innerHTML = formatQuantity2(parseFloat(qty));
                    }
                }).fnSetFilteringDelay().dtFilter([
                    {column_number: 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
                    {column_number: 1, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
        ...
        <script>
            $(document).ready(function () {
                $('#dmpData').dataTable({
                    ...
                    "aaSorting": [[0, "desc"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'sAjaxSource': '<?= site_url('products/getAdjustmentProduct/?v=1&product='.$product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                    ...
                    "aoColumns": [
                        {"mRender": fld}, null, {"mRender": formatQuantity}, {"mRender": SerialNumber}, null, null, {"bSortable": false}
                    ]
                }).fnSetFilteringDelay().dtFilter([
                    {column_number: 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
                    {column_number: 1, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
        ...
        <script>
            $(document).ready(function () {
                var oTable = $('#PRESLData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getReturnsProduct/?v=1&product='.$product->id .'&product_type='.$product->type) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "aoColumns": [{"mRender": fld}, null, null, null, null, {"mRender": formatQuantity2}, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var sc = 0, gtotal = 0, total_qty = 0;
                        for (var i = 0; i < aaData.length; i++) {
                        ...
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[5].innerHTML = formatQuantity2(parseFloat(total_qty));
