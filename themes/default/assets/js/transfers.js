 ...
 function loadItems() {
    ...
    if (localStorage.getItem('toitems')) {
        ...
        $.each(toitems, function () {
			...
			if(serial_no == null || serial_no == 'undefined'){
				serial_no = 0;
			} 
            if (site.settings.tax1 == 1) {
                if (pr_tax !== false) {
			...
			//Show Serial Number
			tr_html+= '<td class="text-right"><input class="form-control input-sm rserial" name="serial[]" type="text" id="serial_' + row_no + '" value="'+serial_no+'"></td>';
