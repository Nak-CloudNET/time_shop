...
function loadItems() {
    if (localStorage.getItem('poitems')) { 
        ...
        $.each(poitems, function () {
			...
			/* Price */
			tr_html += '<td class="text-right"><input style="background:#C15858;color:#fff" type="text" class="form-control text-center rprice" value="'+formatPurDecimal(item.row.price)+'" name="price[]"></td>';
			/* Net Unit Cost */
			//if(item.pii){
			//	tr_html += '<td class="text-right"><input class="form-control text-center rcost" name="net_cost[]" type="text" id="cost_' + row_no + '" value="' + item.pii.net_unit_cost + '"><input class="rucost" name="unit_cost[]" type="hidden" value="' + item.net_unit_cost + '"><input class="realucost" name="real_unit_cost[]" type="hidden" value="' + item.row.real_unit_cost + '"></td>';
			//}else{
			...
			//}
			//tr_html += '<td class="text-right"><input class="form-control text-center rcost" name="net_cost[]" type="text" id="cost_' + row_no + '" value="' + item_cost + '"><input class="rucost" name="unit_cost[]" type="hidden" value="' + unit_cost + '"><input class="realucost" name="real_unit_cost[]" type="hidden" value="' + item.row.real_unit_cost + '"></td>';
			...
			//tr_html += '<td class="text-right"><span class="text-right lcost" id="lcost_' + row_no + '">' + formatPurDecimal(last_cost) + '</span></td>';
